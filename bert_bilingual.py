...
Original file is located at
    https://colab.research.google.com/drive/1axg1oVwiPCoHEYoA6v1g5Ke2C58BJ6-X

## BERT Bilingual Dementia Classifier

Trains BERT (`bert-base-uncased`) on a combined English and Tagalog conversational transcripts and evaluates cross-lingual transfer.
        ...
        for wd in WEIGHT_DECAYS:
            ...
            try:
                for epoch in range(MAX_EPOCHS):
                    ...
                    print(f"  Epoch {epoch+1} loss={loss:.4f} train_acc={train_acc:.3f} val_acc={val_f1:.3f} test_acc={test_acc:.3f} test_f1={test_f1:.3f}")
...
print("Manually setting BEST_BS, BEST_LR, BEST_WD for testing CV code...")
BEST_BS = random.choice(BATCH_SIZES)
BEST_LR = random.choice(LR_CANDIDATES)
BEST_WD = random.choice(WEIGHT_DECAYS)
print(f"Set BEST_BS={BEST_BS}, BEST_LR={BEST_LR:.0e}, BEST_WD={BEST_WD:.0e}")
...
print("\n" + "=" * 75)
print("BILINGUAL-TRAINED BERT — FINAL RESULTS (mean ± std across folds)")
print("=" * 75)

print(f"{'Metric':<28} {'English':>14} {'Tagalog':>14} {'Combined':>14}")
print("-" * 70)
